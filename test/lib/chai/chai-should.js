!function(name, definition) {
		...
		Assertion.prototype.assert = function(expr, msg, negateMsg, expected, actual) {
			...
			if (!ok) {
				throw new AssertionError({
					message: this.msg ? this.msg + ': ' + msg : msg // include custom message if available, actual: actual, expected: expected, stackStartFunction: (Assertion.includeStack) ? this.assert : this.ssfi
				});
			}
		};
	...
	// JamesMGreene: Updated the following lines to expose the "should" interface since
	// I do not have a "require" instance outside of this closure. [2012-04-25]
	var chai = require('chai'),
		should = chai.should();
